<x-layouts.admin title="Berita">
    <x-ui.page-header title="Semua Berita" description="Kelola berita, status terbit, dan kategorinya.">
        <x-slot:actions>
    ...
    <x-ui.data-table
        ...
        caption="Daftar berita dengan pencarian, pengurutan, dan penyaringan"
        :columns="[
            ['key' => 'title', 'label' => 'Judul'],
            ['key' => 'categories_list', 'label' => 'Kategori', 'orderable' => false, 'searchable' => false],
